	...
	<script type="text/javascript">
		...
		function printInfo(xml){
			...
			for(j = 0; j < x.length; j++){
				...
				td += "<td><div class=\"btn-group\"><button type=\"button\" class=\"btn btn-default dropdown-toggle\" data-toggle=\"dropdown\">操作 <span class=\"caret\"></span></button><ul class=\"dropdown-menu\" role=\"menu\"><li><a href=\"backend/seriesedit.jsp?flag=4&seriesid="+xson[0].firstChild.nodeValue+"\">编辑</a></li><li><a href=\"BackendSeriesServlet?flag=2&seriesid="+xson[0].firstChild.nodeValue+"\">删除</a></li></ul></div></td>";
				$('#content').append(td);
			}
		}
...
<form action="backend/seriesadd.jsp" method="post"><input type="submit" class="btn btn-default" value="添加专题"/></form>
