	...
	<script type="text/javascript">
		...
		function printInfo(xml){
			...
			for(j = 0; j < x.length; j++){
				...
				td += "<td><div class=\"btn-group\"><button type=\"button\" class=\"btn btn-default dropdown-toggle\" data-toggle=\"dropdown\">操作 <span class=\"caret\"></span></button><ul class=\"dropdown-menu\" role=\"menu\"><li><a href=\"BackendMovieListServlet?flag=2&movielistid"+xson[0].firstChild.nodeValue+"\">删除</a></li></ul></div></td>";
				$('#content').append(td);
			}
		}
      ...
      <div class="container-fluid">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav navbar-left">
            ...
            <li class="active"><a href="backend/movielist.jsp">影单管理</a></li>
          </ul>
