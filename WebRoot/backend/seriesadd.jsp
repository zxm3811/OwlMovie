...
<div class="container">
  ...
  <form class="form-horizontal" action="BackendSeriesServlet?flag=1" method="get">
    <fieldset>
      <div id="legend" class="">
    ...
    <div class="control-group">
          ...
          <div class="controls">
            <div class="textarea">
                  <textarea type="" class="" name="description"> </textarea>
            </div>
          </div>
        </div><div class="control-group">
        
        <input type="text" value="1" name="flag" hidden="hidden"/>

          <!-- Text input-->
          <label class="control-label" for="input01">电影列表</label>
          <div class="controls">
            <input type="text" placeholder=";2305;" class="input-xlarge" name="movielist">
